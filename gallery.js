...
if (gallery) {
  ...
  dialog.innerHTML = '<div class="gallery-dialog-frame"><form method="dialog"><button class="gallery-close" type="submit">Zatvori</button></form><img class="gallery-dialog-image" alt=""></div>';
